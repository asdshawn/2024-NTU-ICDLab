# Read Design
read_file -format verilog pConv.v

current_design pConv
uniquify
link
...
report_area > area_pConv.out
report_power > power_pConv.out
report_timing -path full -delay max > timing_pConv.out

#write -format db -hierarchy -output $active_design.db
write -format verilog -hierarchy -output pConv_syn.v
write_sdf -version 2.1 -context verilog pConv.sdf
write_sdc pConv.sdc
