# Read Design
read_file -format verilog pMaxPool.v

current_design pMaxPool
uniquify
link
...
report_area > area_pMaxPool.out
report_power > power_pMaxPool.out
report_timing -path full -delay max > timing_pMaxPool.out

#write -format db -hierarchy -output $active_design.db
write -format verilog -hierarchy -output pMaxPool_syn.v
write_sdf -version 2.1 -context verilog pMaxPool.sdf
write_sdc pMaxPool.sdc
